...
const MedicalForm: React.FC = () => {
    ...
    const availableTests = Object.entries(CBC_PARAMETERS)
        ...
        try {
            ...
            const testSubmissions = selectedFields
                ...
                .map(field => {
                    ...
                    const { min, max } = CBC_PARAMETERS[field.testType];
            ...
            <div className="max-w-5xl mx-auto">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
                        <h2 className="text-2xl font-semibold text-gray-800">Record CBC Test Results</h2>
                                        ...
                                        <div className="p-4 rounded-lg border border-gray-200 bg-white 
                                            ...
                                            <div className="relative rounded-md shadow-sm">
                                                <input
                                                    ...
                                                    placeholder={`${CBC_PARAMETERS[field.testType].min}-${CBC_PARAMETERS[field.testType].max}`}
                                                />
                                                <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span className="text-gray-500 sm:text-sm">
                                                        {CBC_PARAMETERS[field.testType].unit}
                                                    </span>
                                                </div>
                                            </div>
                                            <p className="mt-1.5 text-xs text-gray-500">
                                                Normal range: {CBC_PARAMETERS[field.testType].min}-{CBC_PARAMETERS[field.testType].max} {CBC_PARAMETERS[field.testType].unit}
                                            </p>
                                            <button
                                                type="button"
